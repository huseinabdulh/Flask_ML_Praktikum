...
def predict():
    ...
    model_dict = {  'Model2':'static/MLModule/model2(husein).h5',
                    'Model3':'static/MLModule/BatchNormModel(husein).h5',
                    'Model4'   :   'static/MLModule/Modul4BatchNormModel(Husein).h5',
                    'Model5'     :   'static/MLModule/Penugasan5_VGG16(husein).h5',}
...
def predict_result(model, run_time, probs, img):
    class_list = {'mask_weared_incorrect': 0, 'with_mask': 1, 'without_mask':2}
